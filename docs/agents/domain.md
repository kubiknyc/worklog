...
- **`docs/architecture/`** — this repo's existing architecture docs; `docs/architecture/00-README.md` is the index and records which cross-track design decisions are settled vs. open.
