...
export const DOMAIN_COLUMNS = {
  profiles: ['id', 'full_name', 'email', 'phone', 'company', 'trade', 'avatar_url', 'expo_push_token', 'created_at'],
  ...
  projects: [
    'id', 'name', 'address', 'created_by', 'created_at', 'company_id', 'code_prefix',
    'timezone', 'lat', 'lng', 'geocode_source', 'geocoded_at',
  ],
  ...
  daily_reports: [
    'id', 'project_id', 'report_date', 'status', 'has_incident', 'has_delay',
    'created_by', 'created_at', 'submitted_by', 'submitted_at', 'locked_by', 'locked_at',
    'updated_at',
  ],
  ...
  report_delays: ['id', 'report_id', 'cause', 'responsible_party', 'duration_hours', 'is_ongoing', 'note'],
  report_safety_observations: ['id', 'report_id', 'obs_type', 'description', 'is_incident'],
  report_weather: [
    'report_id', 'weather_source', 'auto_condition', 'auto_temp_f', 'auto_fetched_at', 'auto_raw_response',
    'override_condition', 'override_temp_f', 'override_at', 'override_by', 'updated_at',
  ],
  report_photos: [
    'id', 'report_id', 'project_id', 'storage_path', 'trade_tag', 'location_tag', 'caption',
    'source', 'captured_at', 'exif_datetime_original', 'added_at',
    'gps_lat', 'gps_lng', 'gps_accuracy', 'width', 'height',
    'created_by', 'created_at', 'updated_at', 'deleted_at',
  ],
  report_amendments: ['id', 'report_id', 'amendment_number', 'reason', 'created_by', 'created_at', 'signature_id'],
